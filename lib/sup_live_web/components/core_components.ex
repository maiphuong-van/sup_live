defmodule SupLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SupLiveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SupLiveWeb.Gettext, "errors", msg, opts)
    end
  end
